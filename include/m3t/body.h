...
class Body {
 public:
  ...
  // [Joshua] set camera22camera1_pose into a variable
  void mySet_camera22camera1_pose(const Transform3fA &body2camera1_pose, const Transform3fA &camera22body_pose);
  ...
  const Transform3fA &body2world_pose_nMINUS1() const;
  ...
  const Transform3fA &camera12camera2_pose() const;
  const Transform3fA &geometry2world1_pose() const;
  const Transform3fA &geometry2world2_pose() const;
 ...
 //private:
  ...
  Transform3fA body2world_pose_nMINUS1_{Eigen::Translation3f{0.0f, 0.0f, -10.0f}};
  ...
  Transform3fA camera22camera1_pose_{Eigen::Translation3f{0.0f, 0.0f, 0.0f}};
  Transform3fA camera12camera2_pose_{Eigen::Translation3f{0.0f, 0.0f, 0.0f}};
  Transform3fA geometry2world1_pose_{Eigen::Translation3f{0.0f, 0.0f, -10.0f}};
  Transform3fA geometry2world2_pose_{Eigen::Translation3f{0.0f, 0.0f, -10.0f}};
