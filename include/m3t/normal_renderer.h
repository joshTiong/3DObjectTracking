...
class FullNormalRenderer : public FullDepthRenderer {
 public:
  ...
  //Setters
  void set_projectionMatrix_camera1(Eigen::Matrix4f projection_matrix_camera1);
  void set_projectionMatrix_camera2(Eigen::Matrix4f projection_matrix_camera2);

  // Main methods
  bool StartRendering(int viewer_iteration) override;
  ...
  Eigen::Matrix4f projection_matrix_camera1_;
  Eigen::Matrix4f projection_matrix_camera2_;
 private:
  // Helper methods
  bool LoadMetaData();
