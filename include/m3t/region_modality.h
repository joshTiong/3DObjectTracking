...
class RegionModality : public Modality {
 ...
 public:
  ...
  //bool myCalculateCorrespondences(int iteration, int corr_iteration, int n_corr_iterations_) override;
  bool VisualizeCorrespondences(int save_idx) override;
  bool CalculateGradientAndHessian(int iteration, int corr_iteration,
                                   int opt_iteration, int modality_iteration) override;
  ...
  //myGetters
  const Transform3fA body2camera_pose_avg() const;
  ...
  Transform3fA body2camera_pose_nMINUS1_;
  Transform3fA body2camera_pose_avg_;
  Transform3fA body2camera_pose_sum_;
  Transform3fA camera22camera1_pose_;
