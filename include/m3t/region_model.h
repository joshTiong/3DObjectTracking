...
class RegionModel : public Model {
 ...
 public:
  ...
  // [Joshua] sphere radius are distance between camera and object where the object is the center of sphere.
  // It is important to set it as close as possible to the real distance between camera and object.
  // [Joshua] n_divides is the division of geodesic grid. A larger value means more viewpoints are sampled.
  // [Joshua] n_ponts is the number of correspondence lines for one 2D viewpoint.
  ...
  // [Joshua] myGetClosestView considers two perspectives using camera22camera1_pose
  bool myGetClosestView(const Transform3fA &body2camera_pose,
                      const View **closest_view, const Transform3fA &camera22camera1_pose) const;
