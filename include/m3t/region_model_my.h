...
#ifndef M3T_INCLUDE_M3T_MY_REGION_MODEL_H_
#define M3T_INCLUDE_M3T_MY_REGION_MODEL_H_
 ...
 */
class myRegionModel : public Model {
 private:
  // Model definition
 ...
 public:
  ...
  myRegionModel(const std::string &name, const std::shared_ptr<Body> &body_ptr,
              ...
              int image_size = 2000);
  myRegionModel(const std::string &name,
