...
class Viewer {
 public:
  ...
  // Main methods
  virtual bool UpdateViewer(int save_index, int viewer_iteration) = 0;
  //virtual bool myUpdateViewer(int save_index) = 0;
...
class ColorViewer : public Viewer {
 public:
  ...
  // Main methods
  virtual bool UpdateViewer(int save_index, int viewer_iteration) override = 0;
  //virtual bool myUpdateViewer(int save_index, int viewer_iteration) override = 0;
