...
// This function is called in link and tracker
void Body::set_body2world_pose(const Transform3fA &body2world_pose) {
  body2world_pose_nMINUS1_ = body2world_pose_;
  body2world_pose_ = body2world_pose;
  world2body_pose_ = body2world_pose_.inverse();
  geometry2world_pose_ = body2world_pose_ * geometry2body_pose_;
  world2geometry_pose_ = geometry2world_pose_.inverse();
  geometry2world1_pose_ = geometry2world_pose_;
  geometry2world2_pose_ = camera12camera2_pose_*geometry2world1_pose_;
}
...
void Body::mySet_camera22camera1_pose(const Transform3fA &body2camera1_pose, const Transform3fA &camera22body_pose) {
  camera22camera1_pose_ = body2camera1_pose*camera22body_pose;
  camera12camera2_pose_  = camera22camera1_pose_ .inverse();
}
...
const Transform3fA &Body::body2world_pose_nMINUS1() const { return body2world_pose_nMINUS1_; }
...
const Transform3fA &Body::camera22camera1_pose() const { return camera22camera1_pose_; }

const Transform3fA &Body::camera12camera2_pose() const { return camera12camera2_pose_; }

const Transform3fA &Body::geometry2world1_pose() const { return geometry2world1_pose_; }

const Transform3fA &Body::geometry2world2_pose() const { return geometry2world2_pose_; }
