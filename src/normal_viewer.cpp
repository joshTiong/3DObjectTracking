...
bool NormalColorViewer::SetUp() {
  ...
  std::cout << "NormalColorViewer::SetUp()" << std::endl;
...
void NormalColorViewer::set_renderer_geometry_ptr(
  ...
  renderer_geometry_ptr_ = renderer_geometry_ptr;
  set_up_ = false;
  //std::cout << "-------------------------Here____NormalColorViewer::set_renderer_geometry_ptr" << std::endl;
}

void NormalColorViewer::set_opacity(float opacity) { opacity_ = opacity; }

void NormalColorViewer::set_projectionMatrix_camera1(Eigen::Matrix4f projection_matrix_camera1){
  renderer_.set_projectionMatrix_camera1(projection_matrix_camera1);
}

void NormalColorViewer::set_projectionMatrix_camera2(Eigen::Matrix4f projection_matrix_camera2){
  renderer_.set_projectionMatrix_camera2(projection_matrix_camera2);
}

bool NormalColorViewer::UpdateViewer(int save_index, int viewer_iteration) {
  if (!set_up_) {
  ...
  // Render overlay
  renderer_.StartRendering(viewer_iteration);
...
const Eigen::Matrix4f &NormalColorViewer::getProjectionMatrix() const {
  return renderer_.getProjectionMatrix();
}
...
bool NormalDepthViewer::UpdateViewer(int save_index, int viewer_iteration) {
  if (!set_up_) {
