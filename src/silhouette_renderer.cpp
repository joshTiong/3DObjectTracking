...
bool SilhouetteRendererCore::StartRendering(
  ...
  //std::cout << "SilhouetteRendererCore::StartRendering" << std::endl;
...
bool FullSilhouetteRenderer::SetUp() {
  std::cout << "FullSilhouetteRenderer::SetUp()" << std::endl;
...
bool FullSilhouetteRenderer::StartRendering(int viewer_iteration) {
  const std::lock_guard<std::mutex> lock{mutex_};
  if (!set_up_) {
...
bool FocusedSilhouetteRenderer::SetUp() {
  std::cout << "FocusedSilhouetteRenderer::SetUp()" << std::endl;
  const std::lock_guard<std::mutex> lock{mutex_};
  set_up_ = false;
  if (!metafile_path_.empty())
    if (!LoadMetaData()) return false;
...
bool FocusedSilhouetteRenderer::StartRendering(int viewer_iteration) {
  std::cout << "FocusedSilhouetteRenderer::StartRendering(int viewer_iteration)" << std::endl;
